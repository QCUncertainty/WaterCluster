...
At this time we do not konw through which way one could obtain sample water cluster structures better representing the full atomic coordination space. We need numerical evidence to check the generated water cluster structures.
